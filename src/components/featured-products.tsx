...
export function FeaturedProducts() {
    return (
        <section id="products" className="relative py-32 px-6 sm:px-8 bg-black overflow-hidden">
            {/* Background gradient */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                >
                    <span className="text-amber-400/60 text-xs font-medium tracking-[0.3em] uppercase">Handpicked Selection</span>
                        ...
                        >
                            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-b from-white/[0.04] to-transparent border border-white/[0.06] backdrop-blur-sm transition-all duration-500 hover:border-amber-500/20 hover:shadow-[0_0_40px_rgba(212,168,83,0.08)]">
                                ...
                                <div className="absolute top-4 left-4 z-10">
                                    <span className="px-3 py-1 text-[10px] font-semibold tracking-wider uppercase bg-amber-500/90 text-black rounded-full">
                                        {product.badge}
                                    </span>
                                </div>
                                ...
                                <div className="p-6">
                                    <div className="flex items-center gap-1 mb-3">
                                        ...
                                        <span className="text-xs text-neutral-500 ml-2">{product.rating}</span>
                                    </div>

                                    <h3 className="text-xl font-semibold text-white group-hover:text-amber-400 transition-colors duration-300">{product.name}</h3>
                                    <p className="text-sm text-neutral-500 mt-1">{product.category}</p>

                                    <div className="flex items-center justify-between mt-6 pt-4 border-t border-white/5">
                                        <span className="text-2xl font-bold text-white">{product.price}</span>
                                        <motion.button
                                            className="flex items-center gap-2 px-5 py-2.5 bg-white/5 border border-white/10 text-white/80 rounded-full text-sm font-medium transition-all duration-300 hover:bg-amber-500 hover:border-amber-500 hover:text-black"
                ...
                >
                    <a href="#" className="inline-flex items-center gap-2 text-amber-400/70 hover:text-amber-400 text-sm font-medium tracking-wider uppercase transition-colors duration-300 group">
